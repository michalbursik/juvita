...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'event-sourcing.aggregate_event_order_column' => 'string',
            'event-sourcing.stored_snapshots_model' => 'string',
            'event-sourcing.consistency_check_enabled' => 'boolean',
            'event-sourcing.aggregate_caches' => 'array',
            ...
            'vapor.redirect_to_root' => 'boolean',
            'vapor.redirect_robots_txt' => 'boolean',
            'vapor.serve_assets' => 'array',
            'vapor-ui.middleware' => 'array',
            'vapor-ui.domain' => 'NULL',
            'vapor-ui.path' => 'string',
            'vapor-ui.queues' => 'array',
            'view.paths' => 'array',
            ...
            'responder.serializers.success' => 'string',
            'responder.serializers.error' => 'string',
            'responder.decorators' => 'array',
            'responder.fallback_transformer' => 'string',
            'responder.load_relations_parameter' => 'string',
            'responder.filter_fields_parameter' => 'string',
            'responder.recursion_limit' => 'integer',
            'responder.error_message_files' => 'array',
            'responder.use_camel_case_relations' => 'boolean',
...
'database.redis.cache.port','database.redis.cache.database','event-sourcing.auto_discover_projectors_and_reactors','event-sourcing.auto_discover_base_path','event-sourcing.projectors',
'event-sourcing.reactors','event-sourcing.queue','event-sourcing.catch_exceptions','event-sourcing.stored_event_model','event-sourcing.stored_event_repository',
'event-sourcing.snapshot_repository','event-sourcing.snapshot_model','event-sourcing.stored_event_job','event-sourcing.enforce_event_class_map','event-sourcing.event_class_map',
'event-sourcing.event_serializer','event-sourcing.event_normalizers','event-sourcing.cache_path','event-sourcing.dispatch_events_from_aggregate_roots','event-sourcing.aggregate_event_order_column',
'event-sourcing.stored_snapshots_model','event-sourcing.consistency_check_enabled','event-sourcing.aggregate_caches','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.links./var/www/html/public/storage','hashing.driver',
...
'logging.channels.papertrail.handler_with.host','logging.channels.papertrail.handler_with.port','logging.channels.stderr.driver','logging.channels.stderr.level','logging.channels.stderr.handler',
...
'logging.channels.errorlog.level','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','logging.channels.browser.driver',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\BatchWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\CacheWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ClientRequestWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\CommandWatcher.ignore',
'telescope.watchers.Laravel\\Telescope\\Watchers\\DumpWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\EventWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\EventWatcher.ignore','telescope.watchers.Laravel\\Telescope\\Watchers\\ExceptionWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.enabled',
'telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_abilities','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_packages','telescope.watchers.Laravel\\Telescope\\Watchers\\JobWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\LogWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\MailWatcher',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.ignore_packages','telescope.watchers.Laravel\\Telescope\\Watchers\\QueryWatcher.slow','telescope.watchers.Laravel\\Telescope\\Watchers\\RedisWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.size_limit',
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','vapor.redirect_to_root','vapor.redirect_robots_txt',
'vapor.serve_assets','vapor-ui.middleware','vapor-ui.domain','vapor-ui.path','vapor-ui.queues',
'view.paths','view.compiled','boost.enabled','boost.browser_logs_watcher','boost.executable_paths.php',
'boost.executable_paths.composer','boost.executable_paths.npm','boost.executable_paths.vendor_bin','mcp.redirect_domains','livewire.class_namespace',
...
'livewire.inject_morph_markers','livewire.smart_wire_keys','livewire.pagination_theme','livewire.release_token','responder.serializers.success',
'responder.serializers.error','responder.decorators','responder.fallback_transformer','responder.load_relations_parameter','responder.filter_fields_parameter',
'responder.recursion_limit','responder.error_message_files','responder.use_camel_case_relations','ide-helper.filename','ide-helper.models_filename',
...
'livewire.upload-file','livewire.preview-file','api.login','login','logout','warehouses.trash','warehouses.index','warehouses.create','warehouses.show',
'warehouses.edit','warehouses.products.show','warehouses.products.receipt','warehouses.products.issue','warehouses.products.transmission',
'overviews.index','movements.index','discounts.index','discounts.create','discounts.edit',
'users.index','users.create','users.edit','checks.index','checks.create',
'checks.show','products.index','products.create','products.edit','api.discounts.index','discounts.create','api.discounts.store','api.discounts.show',
'discounts.edit','api.discounts.update','api.discounts.destroy','api.warehouses.trash','api.movements.index',
'api.warehouses.products.show','api.warehouses.products.receipt','api.warehouses.products.issue','api.warehouses.products.transmission','api.movements.transmission',
'api.movements.trash','api.movements.receipt','api.users.index','users.create','api.users.store',
'api.users.show','users.edit','api.users.update','api.users.destroy','api.priceLevels.index',
'api.movements.fetchAllAmounts','api.movements.list','api.overview.index','api.checks.fetchAllProducts','api.checks.index',
'checks.create','api.checks.store','api.checks.show','checks.edit','api.checks.update',
'api.checks.destroy','warehouses.create','api.warehouses.store','warehouses.edit','api.warehouses.update',
'api.warehouses.destroy','movements.create','api.movements.show','movements.edit','api.movements.update',
'api.movements.destroy','api.products.nextOrder','products.create','api.products.store','products.edit',
'api.products.update','api.products.destroy','api.warehouses.index','api.warehouses.show','api.products.index',
'api.products.show',);
        registerArgumentsSet('views', 
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','components.button','components.card','components.input','components.input-error',
'components.label','components.movement-legend','components.nav-link','components.select','components.table',
'layouts.app','livewire.auth.login','livewire.checks.create','livewire.checks.index','livewire.checks.show',
'livewire.discounts.create','livewire.discounts.edit','livewire.discounts.index','livewire.movements.index','livewire.overviews.index',
'livewire.products.create','livewire.products.edit','livewire.products.index','livewire.products.show','livewire.users.create',
'livewire.users.edit','livewire.users.index','livewire.warehouses.create','livewire.warehouses.edit','livewire.warehouses.index',
'livewire.warehouses.products.issue','livewire.warehouses.products.receipt','livewire.warehouses.products.transmission','livewire.warehouses.show','laravel-exceptions-renderer::components.badge',
...
'validation.custom.attribute-name.rule-name','global.issue','global.receipt','global.transmission','global.check',
'global.trash','validation.password',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'API_URL','APP_PORT','LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL',
'DB_CONNECTION','DB_HOST','DB_PORT','FORWARD_DB_PORT','DB_DATABASE',
'DB_USERNAME','DB_PASSWORD','BROADCAST_DRIVER','CACHE_DRIVER','FILESYSTEM_DRIVER',
'QUEUE_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME','MAIL_MAILER','VITE_PORT',
'ASSET_URL','AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET',
