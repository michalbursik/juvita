...
'livewire.upload-file','livewire.preview-file','api.login','login','logout','warehouses.index','warehouses.create','warehouses.show','warehouses.edit',
'warehouses.trash','warehouses.products.show','warehouses.products.receipt','warehouses.products.issue','warehouses.products.transmission',
...
'components.label','components.nav-link','components.select','components.table','layouts.app',
'livewire.auth.login','livewire.checks.create','livewire.checks.index','livewire.checks.show','livewire.discounts.create',
'livewire.discounts.edit','livewire.discounts.index','livewire.movements.index','livewire.overviews.index','livewire.products.create',
'livewire.products.edit','livewire.products.index','livewire.products.show','livewire.users.create','livewire.users.edit',
'livewire.users.index','livewire.warehouses.create','livewire.warehouses.edit','livewire.warehouses.index','livewire.warehouses.products.issue',
'livewire.warehouses.products.receipt','livewire.warehouses.products.transmission','livewire.warehouses.show','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
