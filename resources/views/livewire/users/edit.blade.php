<div>
    <div class="flex items-center mb-8">
        ...
        <h2 class="text-3xl font-extrabold text-gray-900">Upravit uživatele: {{ $user->name }}</h2>
    </div>
        ...
        <form wire:submit.prevent="submit">
            <x-card class="overflow-hidden">
                <div class="space-y-6">
                    ...
                    <div>
                        <x-label for="password" value="Heslo (nechte prázdné pro zachování stávajícího)" />
