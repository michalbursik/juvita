            ...
            <div class="col-12 col-lg-10">
                <div class="row mb-3">
                    <div class="col-12 col-sm">
                        <h1 class="h1">Přehled všech pohybů na skladech</h1>
                    </div>
                </div>
...
{{--                </div>--}}
                ...
                <div class="row">
                    <div class="col">
                        <input placeholder="Vyhledej" type="text" class="form-control" name="search" id="search">
                    </div>
                    <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            @foreach($movements as $movement)
                                <tr class="{{ $movement->type }}-color">
                                    <td>{{ $movement->product->name }}</td>
                                    <td>{{ trans('global.' .$movement->type) }}</td>
