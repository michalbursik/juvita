  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10">
        ...
        <div class="row">
          <div :id="`product_${product.id}`" v-for="product of currentWarehouse.products"
               class="col-6 col-md-4 col-lg-3"
          >
            <div class="card mt-3" :style="`
                background: url(${asset(product.image)}) white no-repeat 50% 100%;
                background-size: contain;
                border-bottom-left-radius: 0; border-bottom-right-radius: 0;
              `">
              <nuxt-link :to="`/warehouses/${currentWarehouse.id}/products/${product.id}`" style="text-decoration: none;">
            ...
            <div class="row">
              <div class="col text-center">
                <div class="btn-group w-100" role="group" aria-label="Product operations">
                  ...
                  <nuxt-link event="" @click.native="changePage(`/warehouses/${currentWarehouse.id}/products/${product.id}/transmission`, product.id)" to="" type="button" class="btn btn-warning" style="border-top-left-radius: 0; border-top-right-radius: 0;">
                  ...
                  <nuxt-link event="" @click.native="changePage(`/warehouses/${currentWarehouse.id}/products/${product.id}/issue`, product.id)" to="" type="button" class="btn btn-danger" style="border-top-left-radius: 0; border-top-right-radius: 0;">
